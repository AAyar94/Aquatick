...
@Composable
fun NightTimePicker(
    viewModel: NightTimeViewModel = hiltViewModel(),
    onNextClick: () -> Unit,
) {
    LaunchedEffect(true) {
    ...
    Box(
        ...
        val nightTimeSetter = rememberTimePickerState(21, 0, true)
        ...
        Box(
            ...
            Column(
                ...
                val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(com.aayar94.core_ui.R.raw.good_night_anim))
                LottieAnimation(
                ...
                Text(
                    text = stringResource(id = R.string.enter_your_going_bed_time),
                    color = MaterialTheme.colorScheme.onBackground,
                    style = MaterialTheme.typography.bodyMedium
                )
                TimePicker(
                    state = nightTimeSetter,
                    modifier = Modifier.padding(horizontal = spacing.spaceExtraSmall),
                    layoutType = TimePickerLayoutType.Vertical
                )
                Spacer(modifier = Modifier.height(spacing.spaceMedium))
                Text(
                    text = stringResource(id = R.string.this_clock_will_used_for),
                    color = MaterialTheme.colorScheme.onBackground,
                    style = MaterialTheme.typography.bodyMedium
                )
                Spacer(modifier = Modifier.height(spacing.spaceMedium))
